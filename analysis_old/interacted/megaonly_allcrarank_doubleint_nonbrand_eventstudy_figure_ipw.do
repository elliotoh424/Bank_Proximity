...
drop if month_id == .
keep if strpos(parm, "_ImonXmega_")>0
drop parm
tempfile gap
isid month_id
save `gap', replace
...
, xline(15.2, lstyle(dot)) scheme(aspen) legend(row(2) order( 1 "Mega-No bank Gap (No Controls)" 2 "95% CI")) yline(0) ///
title("Mega Bank Proximity on Independent Pharmacies") ///
xlab( ///
4 "4/19" 8 "8/19" 12 "12/19" 16 "4/20" 20 "8/20" 24 "12/20" 28 "4/21" 32 "8/21" 36 "12/21" 40 "4/22" 44 "8/22" 48 "12/22") xtitle(Date) 
graph export "figures/megaonly_double_int_`var'rank_noctrl_radius`yd'_cty_ipw_int.png", replace
...
, xline(15.2, lstyle(dot)) scheme(aspen) legend(row(2) order( 1 "Mega-No bank Gap (Microarea, Tract Controls)" 2 "95% CI")) yline(0) ///
title("Mega Bank Proximity on Independent Pharmacies") ///
xlab( ///
4 "4/19" 8 "8/19" 12 "12/19" 16 "4/20" 20 "8/20" 24 "12/20" 28 "4/21" 32 "8/21" 36 "12/21" 40 "4/22" 44 "8/22" 48 "12/22") xtitle(Date) 
graph export "figures/megaonly_double_int_`var'rank_ctrl1_radius`yd'_cty_ipw_int.png", replace
...
, xline(15.2, lstyle(dot)) scheme(aspen) legend(row(2) order( 1 "Mega-No bank Gap (All Controls)" 2 "95% CI" )) yline(0) ///
title("Mega Bank Proximity on Independent Pharmacies") ///
xlab( ///
4 "4/19" 8 "8/19" 12 "12/19" 16 "4/20" 20 "8/20" 24 "12/20" 28 "4/21" 32 "8/21" 36 "12/21" 40 "4/22" 44 "8/22" 48 "12/22") xtitle(Date) 
graph export "figures/megaonly_double_int_`var'rank_ctrl2_radius`yd'_cty_ipw_int.png", replace
