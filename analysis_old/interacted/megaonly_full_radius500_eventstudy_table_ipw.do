...
global output_file "tables/megaonly_full_eventstudy_table_radius`yd'_ipw_int"
...
****** One megabank only
* Nonbrand post in periods - Original DV
eststo: reghdfe `yvar' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 [aw= ipw] if d_nbrand & nmega500 <= 1, absorb(cty_ym_id) vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "N"
qui estadd local tract_ctrl "N"
...
eststo: reghdfe `yvar' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 [aw= ipw] if d_nbrand & nmega500 <= 1, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
...
eststo: reghdfe `yvar' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 dln_brn500 [aw= ipw] if d_nbrand & nmega500 <= 1, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
...
eststo: reghdfe dln_ind`yd' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 [aw= ipw] if d_nbrand, absorb(cty_ym_id) vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "N"
qui estadd local tract_ctrl "N"
...
eststo: reghdfe dln_ind`yd' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 [aw= ipw] if d_nbrand, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
...
eststo: reghdfe dln_ind`yd' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 dln_brn500 [aw= ipw] if d_nbrand, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
...
****** One megabank only
* Nonbrand post in periods - Using dln_ind`yd' as DV
eststo: reghdfe dln_ind`yd' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 [aw= ipw] if d_nbrand & nmega500 <= 1, absorb(cty_ym_id) vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "N"
qui estadd local tract_ctrl "N"
...
eststo: reghdfe dln_ind`yd' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 [aw= ipw] if d_nbrand & nmega500 <= 1, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
...
eststo: reghdfe dln_ind`yd' mega`yd'Xpost_apr20_mar21 mega`yd'Xpost_apr21_mar22 mega`yd'Xpost_apr22_nov22 dln_brn500 [aw= ipw] if d_nbrand & nmega500 <= 1, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
