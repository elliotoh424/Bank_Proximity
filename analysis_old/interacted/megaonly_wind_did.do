...
use "C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/advan/craexam_drugstore.dta", clear
drop if npoi500 <= 5
...
merge m:1 placekey using "C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/advan/megaonly_radius500_ipw.dta", assert(1 3)
drop if d_brand == 1
...
global output_file "tables/megaonly_exam_foottraffic_did_int"
