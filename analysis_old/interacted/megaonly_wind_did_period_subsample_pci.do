...
foreach var of varlist TAmtSBLru QAmtSBLru Tmedincu Qmedincu Tnmedincu Qnmedincu lmi_all19 {
...
foreach restriction of varlist Hpciu Qpciu Tpciu{
...
global output_file "tables/megaonly_exam_foottraffic_did_int_`var'_`restriction'_pd3"
...
********************************************************************************
* MEGA ONLY REGRESSIONS - FOR RESTRICTION == 1
********************************************************************************

********************************************************************************
* MEGA ONLY REGRESSIONS - BASELINE (RESTRICTION == 1)
********************************************************************************
...
dln_brn500 ///
[aw = ipw] if d_nbrand & post_apr22_nov22 & `restriction' == 1, ///
...
qui estadd local sample "Only Mega`yd' with `restriction'"

********************************************************************************
* MEGA ONLY REGRESSIONS - WINDOW 10 (RESTRICTION == 1)
********************************************************************************
...
********************************************************************************
* MEGA ONLY REGRESSIONS - WINDOW 11 (RESTRICTION == 1)
********************************************************************************
...
********************************************************************************
* MEGA ONLY REGRESSIONS - WINDOW 12 (RESTRICTION == 1)
********************************************************************************
...
********************************************************************************
* MEGA ONLY REGRESSIONS - WINDOW 13 (RESTRICTION == 1)
********************************************************************************
...
********************************************************************************
* MEGA ONLY REGRESSIONS - FOR RESTRICTION == 0
********************************************************************************

********************************************************************************
* MEGA ONLY REGRESSIONS - BASELINE (RESTRICTION == 0)
********************************************************************************
...
mega500 mega500X`var' ///
dln_brn500 ///
[aw = ipw] if d_nbrand & post_apr22_nov22 & `restriction' == 0, ///
absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local cluster "Store"
qui estadd local microarea_ctrl "Y"
qui estadd local tract_ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "Only Mega`yd' without `restriction'"

********************************************************************************
* MEGA ONLY REGRESSIONS - WINDOW 10 (RESTRICTION == 0)
********************************************************************************
...
********************************************************************************
* MEGA ONLY REGRESSIONS - WINDOW 11 (RESTRICTION == 0)
********************************************************************************
...
********************************************************************************
* MEGA ONLY REGRESSIONS - WINDOW 12 (RESTRICTION == 0)
********************************************************************************
...
********************************************************************************
* MEGA ONLY REGRESSIONS - WINDOW 13 (RESTRICTION == 0)
********************************************************************************
...
********************************************************************************
* ONE MEGA REGRESSIONS - FOR RESTRICTION == 1
********************************************************************************

********************************************************************************
* ONE MEGA REGRESSIONS - BASELINE (RESTRICTION == 1)
********************************************************************************
...
mega500 mega500X`var' ///
dln_brn500 ///
[aw = ipw] if d_nbrand & nmega500 <= 1 & post_apr22_nov22 & `restriction' == 1, ///
absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local cluster "Store"
qui estadd local microarea_ctrl "Y"
qui estadd local tract_ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "One Mega`yd' with `restriction'"

********************************************************************************
* ONE MEGA REGRESSIONS - WINDOW 10 (RESTRICTION == 1)
********************************************************************************
...
********************************************************************************
* ONE MEGA REGRESSIONS - WINDOW 11 (RESTRICTION == 1)
********************************************************************************
...
********************************************************************************
* ONE MEGA REGRESSIONS - WINDOW 12 (RESTRICTION == 1)
********************************************************************************
...
********************************************************************************
* ONE MEGA REGRESSIONS - WINDOW 13 (RESTRICTION == 1)
********************************************************************************
...
********************************************************************************
* ONE MEGA REGRESSIONS - FOR RESTRICTION == 0
********************************************************************************

********************************************************************************
* ONE MEGA REGRESSIONS - BASELINE (RESTRICTION == 0)
********************************************************************************
...
mega500 mega500X`var' ///
dln_brn500 ///
[aw = ipw] if d_nbrand & nmega500 <= 1 & post_apr22_nov22 & `restriction' == 0, ///
absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local cluster "Store"
qui estadd local microarea_ctrl "Y"
qui estadd local tract_ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "One Mega`yd' without `restriction'"

********************************************************************************
* ONE MEGA REGRESSIONS - WINDOW 10 (RESTRICTION == 0)
********************************************************************************
...
********************************************************************************
* ONE MEGA REGRESSIONS - WINDOW 11 (RESTRICTION == 0)
********************************************************************************
...
********************************************************************************
* ONE MEGA REGRESSIONS - WINDOW 12 (RESTRICTION == 0)
********************************************************************************
...
********************************************************************************
* ONE MEGA REGRESSIONS - WINDOW 13 (RESTRICTION == 0)
********************************************************************************
