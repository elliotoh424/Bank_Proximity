...
global output_file "tables/megaonly_exam_foottraffic_did_lmi_int"
...
* Baseline
********************************************************************************
* Microarea brand traffic_it - LMI tract
eststo: reghdfe `yvar' ///
mega500Xp_apr20_mar21 mega500Xp_apr21_mar22 mega500Xp_apr22_nov22 ///
dln_brn500 ///
[aw = ipw] if d_nbrand & lmi_all19 == 1, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local cluster "Cty-Month"
qui estadd local ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "Only Mega`yd' - LMI tract"

* Microarea brand traffic_it - Non-LMI tract
eststo: reghdfe `yvar' ///
mega500Xp_apr20_mar21 mega500Xp_apr21_mar22 mega500Xp_apr22_nov22 ///
dln_brn500 ///
[aw = ipw] if d_nbrand & lmi_all19 == 0, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local cluster "Cty-Month"
qui estadd local ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "Only Mega`yd' - Non-LMI tract"

* Microarea brand traffic_it - LMI tract
eststo: reghdfe `yvar' ///
mega500Xp_apr20_mar21 mega500Xp_apr21_mar22 mega500Xp_apr22_nov22 ///
dln_brn500 ///
[aw = ipw] if d_nbrand & nmega500 <= 1 & lmi_all19 == 1, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local cluster "Cty-Month"
qui estadd local ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "One Mega`yd' - LMI tract"

* Microarea brand traffic_it - Non-LMI tract
eststo: reghdfe `yvar' ///
mega500Xp_apr20_mar21 mega500Xp_apr21_mar22 mega500Xp_apr22_nov22 ///
dln_brn500 ///
[aw = ipw] if d_nbrand & nmega500 <= 1 & lmi_all19 == 0, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local cluster "Cty-Month"
qui estadd local ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "One Mega`yd' - Non-LMI tract"
...
collabels("",lhs("DV:ln(\#Visits)")) star(* 0.10 ** 0.05 *** 0.01) cells(b(star fmt(3) ) se(par(( )) fmt(3))) ///
 stats(N fe1 cluster ctrl sample variable r2_a F, fmt(0 0 0 0 0 0 2 2) labels("Nobs" "FE" "Cluster" "Controls" "Sample" "Variable" "Adj. R$^{2}$" "F Stat")) ///
