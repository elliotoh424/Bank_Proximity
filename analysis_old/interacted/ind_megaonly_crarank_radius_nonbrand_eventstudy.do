...
local suffix s
foreach yvar of varlist dln_visits_micro_mar20{
local yd 500
...
global output_file "tables/ind_megaonly_nb_eventstudy_table_radius`yd'_ipw_trcra_`suffix'_int_`yvar'_megabank"
