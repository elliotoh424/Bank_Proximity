...
graph combine g2 g5 g7 g8 , cols(2) imargin(zero) title("All Tracts with CRA loans")
graph export "C:/Users/elliotoh/Box/lodes_shared/pharmacy/results/figure/all19_nobank_binscatter_raw_select.png", replace


graph combine g1 g2 g3 g4 g5 g6 g7 g8 g9 g10 g11 g12, cols(4) imargin(zero) title("All Tracts with CRA loans")
graph export "C:/Users/elliotoh/Box/lodes_shared/pharmacy/results/figure/all19_nobank_binscatter_raw_full.png", replace
