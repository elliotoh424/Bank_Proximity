...
g cb`yd'Xp_apr20_mar21 = cb`yd' * post_apr20_mar21
g noncb`yd'Xp_apr20_mar21 = noncb`yd' * post_apr20_mar21
g cb`yd'Xp_apr21_mar22 = cb`yd' * post_apr21_mar22
g noncb`yd'Xp_apr21_mar22 = noncb`yd' * post_apr21_mar22
g cb`yd'Xp_apr22_nov22 = cb`yd' * post_apr22_nov22
...
* Post by period
eststo: reghdfe `yvar' ///
cb`yd'Xp_apr20_mar21 noncb`yd'Xp_apr20_mar21 ///
cb`yd'Xp_apr21_mar22 noncb`yd'Xp_apr21_mar22 ///
cb`yd'Xp_apr22_nov22 noncb`yd'Xp_apr22_nov22 ///
...
cb`yd'Xp_apr20_mar21 noncb`yd'Xp_apr20_mar21 ///
cb`yd'Xp_apr21_mar22 noncb`yd'Xp_apr21_mar22 ///
cb`yd'Xp_apr22_nov22 noncb`yd'Xp_apr22_nov22 dln_all`yd' ///
[aw= ipw] if d_nbrand, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
...
cb`yd'Xp_apr20_mar21 noncb`yd'Xp_apr20_mar21 ///
cb`yd'Xp_apr21_mar22 noncb`yd'Xp_apr21_mar22 ///
cb`yd'Xp_apr22_nov22 noncb`yd'Xp_apr22_nov22 dln_brn`yd' ///
[aw= ipw] if d_nbrand, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
...
coefplot , keep( ///
noncb`yd'Xp_apr20_mar21 ///
noncb`yd'Xp_apr21_mar22 ///
noncb`yd'Xp_apr22_nov22 ) vertical yline(0) ytitle(dln(\#Visits Rel. to Mar. 2020)) title("Proximity to Non-Community Bank") /// 
coeflabels( ///
noncb`yd'Xp_apr20_mar21 = `""noncb`yd'X" "Recovery1""' ///
noncb`yd'Xp_apr21_mar22 = `""noncb`yd'X" "Recovery2""' ///
noncb`yd'Xp_apr22_nov22  = `""noncb`yd'X" "Recovery3""' ) saving("noncb", replace)

coefplot , keep( ///
cb`yd'Xp_apr20_mar21 ///
cb`yd'Xp_apr21_mar22 ///
cb`yd'Xp_apr22_nov22) vertical yline(0) ytitle(dln(\#Visits Rel. to Mar. 2020)) title("Proximity to Community Bank") /// 
coeflabels( ///
cb`yd'Xp_apr20_mar21 = `""cb`yd'X" "Recovery1""' ///
cb`yd'Xp_apr21_mar22 = `""cb`yd'X" "Recovery2""' ///
cb`yd'Xp_apr22_nov22  = `""cb`yd'X" "Recovery3""') saving("cb", replace)
...
cb`yd'Xp_apr20_mar21 noncb`yd'Xp_apr20_mar21 ///
cb`yd'Xp_apr21_mar22 noncb`yd'Xp_apr21_mar22 ///
cb`yd'Xp_apr22_nov22 noncb`yd'Xp_apr22_nov22 dln_ind`yd' ///
[aw= ipw] if d_nbrand, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
...
cb`yd'Xp_apr20_mar21 noncb`yd'Xp_apr20_mar21 ///
cb`yd'Xp_apr21_mar22 noncb`yd'Xp_apr21_mar22 ///
cb`yd'Xp_apr22_nov22 noncb`yd'Xp_apr22_nov22 dln_rem`yd' ///
[aw= ipw] if d_nbrand, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
