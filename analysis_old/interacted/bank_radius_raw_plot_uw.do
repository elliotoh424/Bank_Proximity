...
collapse (mean) dln_visits_mar20_brand dln_visits_mar20_nbrand dln_visits_mar20, by(start month_id bank`yd')
...
xlab( ///
4 "4/19" 8 "8/19" 12 "12/19" 16 "4/20" 20 "8/20" 24 "12/20" 28 "4/21" 32 "8/21" 36 "12/21" 40 "4/22" 44 "8/22" 48 "12/22") xline(15, lstyle(dot)) xtitle(Date) ytitle(Cumulative Change in Foot Traffic) title(Independents with Nearby Bank vs. No Nearby Bank)
graph export "figures/bank`yd'_gap_nonbrands_uw.png", replace
restore
...
collapse (mean) dln_visits_mar20_mega dln_visits_mar20_nonmega dln_visits_mar20_cb, by(start month_id )
...
graph export "figures/banksize`yd'_gap_nonbrands_uw.png", replace
restore
