...
global output_file "tables/ind_megaonly_nb_eventstudy_table_radius`yd'_ipw_trcra_`suffix'_int"
...
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
qui estadd local sample "One Megabank - Top 50%"
...
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
qui estadd local sample "One Megabank - Top 33%"
...
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
qui estadd local sample "One Megabank - Top 25%"
