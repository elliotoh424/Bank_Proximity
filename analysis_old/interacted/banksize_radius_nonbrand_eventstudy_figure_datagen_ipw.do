...
xi i.month_id|mega`yd' i.month_id|nonmega`yd' i.month_id|cb`yd', noomit
drop *`baseperiod'

local yvar "dln_visits_mar20"

global output_file "tables/banksize_nonbrand_eventstudy_figure_radius`yd'_jan2020_ipw"
...
eststo: reghdfe `yvar' _ImonXmega_* _ImonXnonm_* _ImonXcb50_* [aw= ipw], absorb(cty_ym_id) vce(cluster id_ad)
...
eststo: reghdfe `yvar' _ImonXmega_* _ImonXnonm_* _ImonXcb50_* [aw= ipw], absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
...
* Microarea and tract controls
eststo: reghdfe `yvar' _ImonXmega_* _ImonXnonm_* _ImonXcb50_* dln_brn`yd' [aw= ipw], absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
...
save "tables/full_banksize_nonbrand_`yd'yd_cty_eventstudy_ipw.dta", replace
restore
}
