...
global output_file "tables/ind_megaonly_exam_foottraffic_did_int_nw"
...
qui estadd local tract_ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "Only Mega`yd' `ptile'"

* Microarea brand traffic_it 
eststo: reghdfe `yvar' ///
mega500Xp_apr20_mar21 mega500Xp_apr21_mar22 mega500Xp_apr22_nov22 ///
dln_brn500 ///
if d_nbrand & nmega500 <= 1, ///
absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local cluster "Store"
qui estadd local microarea_ctrl "Y"
...
qui estadd local tract_ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "One Mega`yd' `ptile'"
...
local percentiles "Tnest9 Qnest9 Tnest19 Qnest19"
foreach ptile of local percentiles {
...
qui estadd local tract_ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "Only Mega`yd' not `ptile'"
...
qui estadd local tract_ctrl "Y"
qui estadd local variable "`yvar'"
qui estadd local sample "One Mega`yd' not `ptile'"
