...
global output_file "tables/ind_banksize_nb_eventstudy_table_radius`yd'_ipw_int"
eststo clear
...
cb`yd'Xp_apr20_mar21 cb`yd'Xp_apr21_mar22 cb`yd'Xp_apr22_nov22 ///
dln_brn`yd' ///
[aw= ipw] if d_nbrand & Tnest_9, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
...
cb`yd'Xp_apr20_mar21 cb`yd'Xp_apr21_mar22 cb`yd'Xp_apr22_nov22 ///
dln_brn`yd' ///
[aw= ipw] if d_nbrand & Qnest_9, absorb(cty_ym_id `drug_control' `microarea_control' `tract_control') vce(cluster id_ad)
qui estadd local fe1 "Cty-Month FE"
qui estadd local fe2 ""
qui estadd local micro_ctrl "Y"
qui estadd local tract_ctrl "Y"
