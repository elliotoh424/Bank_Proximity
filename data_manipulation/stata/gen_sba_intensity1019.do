...
merge m:1 cty using "C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/sba/sba1019_cty.dta"
drop if _merge == 2
foreach var of varlist LoanAmt1019 NoLoan1019 est1019 NoLoan_est1019 LoanAmt_est1019 {
	replace `var' = 0 if _merge == 1
}
// keep if d_brand == 0 & mega500 == 1 & nonmega500 == 0 & cb500 == 0
// unique cty if d_brand == 0
// unique cty 
keep cty LoanAmt1019 NoLoan1019 est1019 NoLoan_est1019 LoanAmt_est1019
duplicates drop
unique cty
ren LoanAmt* AmtSBA*
ren NoLoan* NoSBA*
...
foreach var of varlist AmtSBA1019 NoSBA1019 NoSBA_est1019 AmtSBA_est1019{
su `var', d
_pctile `var', p(67)
di r(r1)
}
...
save "C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/pharmacy_sba_intensity1019.dta", replace
