use "C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/office/advan/banksize_sod.dta", clear
keep rssdid mega_asset
tempfile bank
save `bank', replace
...
merge m:1 rssdid using `bank', assert(2 3)
ren *_asset *
keep if mega == 1
drop _merge
tempfile store_mega
...
merge m:1 idrssd using `mega_bank'
keep if _merge == 3
drop _merge
save "temp_callreport.dta", replace
...
drop if rssdid == 675332 /* BB&T and Suntrust merger */
...
unique placekey yq
unique placekey
save "C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/office/advan/allmega_depgrowth_rank.dta", replace
