...
dates = ['2019-03-01','2019-04-01','2019-05-01','2019-06-01',
            '2019-07-01','2019-08-01','2019-09-01','2019-10-01','2019-11-01','2019-12-01',
            '2020-01-01','2020-02-01','2020-03-01','2020-04-01','2020-05-01','2020-06-01',
            '2020-07-01','2020-08-01','2020-09-01','2020-10-01','2020-11-01','2020-12-01',
            '2021-01-01','2021-02-01','2021-03-01','2021-04-01','2021-05-01','2021-06-01',
...
for d in dates:
    ...
    #        
    naics = pd.read_excel('C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/naics_code2017.xlsx')
    ...
    naics_cols = [col for col in advan.columns if col.startswith('naics_') and col != 'naics_code']
    ...
    bank_geo_combined.to_parquet(
            f'C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/advan/intermediate/advan_tract_nearby_businesses_{d}.parquet',
            index=False, compression='zstd'
    )
    # geographic_df.append(bank_geo_combined)
    #
    # Clean up memory
    del advan, tract_agg, naics_tract_agg, bank_geo_combined
    gc.collect()    
    t2 = time.time()
...
#         'C:/Users/elliotoh/Box/lodes_shared/pharmacy/data/advan/advan_tract_nearby_businesses.parquet',
#         index=False, compression='zstd'
#     )
